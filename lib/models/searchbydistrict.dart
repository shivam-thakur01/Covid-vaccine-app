...
class SearchByDistrict extends StatefulWidget {
  ...
  final String date;
  SearchByDistrict({@required this.districtId, @required this.date});
          ...
          Column(mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Container(
                ...
                child: Text('No vaccine center found\nTry another District code',style: TextStyle(color: Colors.white,fontSize: 21,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)),
              Container(
                width: double.infinity,
                padding: EdgeInsets.symmetric(vertical: 8),
