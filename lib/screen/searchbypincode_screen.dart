...
import 'package:vaccine_update/models/searchbypincode.dart';
          ...
          child: Column(
            children: [
                ...
                children: [
                  ...
                  MaterialButton(
                    onPressed: () => Navigator.pushReplacement(context,
                        MaterialPageRoute(builder: (ctx) => PincodeScreen())),
                    child: Text(
                      'Reset',
                      style: TextStyle(
                        fontFamily: 'RobotoCondensed',
              ...
              Container(
                ...
                ):InitialWidget(text: 'Get your shot by Area Pincode',img: 'novaccine',)
              )
            ],
          ),
        ),
